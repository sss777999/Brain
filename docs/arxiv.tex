...
three-layer program (\textit{all like a brain}): layer~2, inference during sleep, in
which sharp-wave-ripple replay composes a new edge A--C from A--B and B--C across
cycles; and layer~3, a basal-ganglia controller trained by reward-prediction error
that decides when to answer reflexively versus deliberate. The cycle is not yet the
