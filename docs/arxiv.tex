...
\item \textbf{Sparse Distributed Representations} --- Words encoded as sparse binary vectors (2048 bits, $\sim$40 active = 2\% sparsity) following HTM theory \citep{hawkins2004intelligence}. SDR overlap captures semantic similarity: similar concepts share active bits. CA3 scoring uses SDR overlap as parallel bonus component, enabling natural generalization without breaking existing string-based retrieval.
